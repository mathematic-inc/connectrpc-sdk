...
/**
 * The plugin binary, which emits one language per invocation.
 *
...
const plugin = createEcmaScriptPlugin<RustOptions & { language: "typescript" | "rust" }>({
